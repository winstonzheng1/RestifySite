...
//        validate(name,value);
    ...
    const handleSubmit = (e) => {
        ...
        $.ajax({
            url: 'http://localhost:8000/restaurants/menu/',
            method: 'POST',
...
//                setFormError("User added");
                alert("Item added")
                window.location.href = "/myrestaurant/addmenu";
            },
      ...
      <div className="container pt-4">
        <div className="columns is-centered">
            <div className="column is-half">
                <p className="title has-text-centered has-text-weight-bold">Add to your menu</p>
        ...
        <div className="columns is-centered">
                <div className="column is-four-fifths">
                    <form className="pb-6" onSubmit={handleSubmit}>
                        ...
                        <div className="control">
                            <button className="button is-success">Add this item to menu</button>
                        </div>
                    </form>
                </div>
        </div>
