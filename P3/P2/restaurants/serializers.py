...
class RestaurantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Restaurant
        fields = (
            'id', 'owner_id', 'name', 'address', 'description', 'postal_code', 'primary_image', 'image', 'banner', 
...
class FoodItemSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):  #create an instance from retrieved validated data
        ...
        follows = RestaurantFollow.objects.filter(restaurant__id=instance.restaurant_id)
        for follow in follows:
            # Add a notification
            Notification.objects.create(receiver=follow.user, restaurantNotifier=Restaurant.objects.get(id=instance.restaurant_id),
