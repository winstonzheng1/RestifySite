...
class Restaurant(models.Model):
    ...
    postal_code = models.CharField(validators=[
                                    RegexValidator(regex=r'^[ABCEGHJ-NPRSTVXY]\d[ABCEGHJ-NPRSTV-Z]\d[ABCEGHJ-NPRSTV-Z]\d$',   
                                    message="Invalid format for postal code. Example: A1A4C4. Ensure to use capital letters only")
                                    ],
...
class FoodItem(models.Model):
    ...
    price = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True) #max price less than 1k, 2 decimal places for cents
